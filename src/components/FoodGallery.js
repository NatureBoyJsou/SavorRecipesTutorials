  ...
  return (
    <div className="gallery-container" {...swipeHandlers}>
      <h2 style={{ textAlign: "center", color: "black", backgroundColor: "yellow", fontFamily: "RubikDirt" , fontWeight: "100" , marginBottom: "1rem" }}>
        All Photos On This Website Are Placeholder Images Generated by Razer Axon AI. They Will Be Replaced With Original Photos. Except the Mobile App Photo-That is My Original IP. Background Videos Are Stock, Public Domain from Clip Champ. Email API Used for Contact Me is Email.JS Last Updated Date is Dynamically Linked to Last Github Push
      </h2>
      <img
